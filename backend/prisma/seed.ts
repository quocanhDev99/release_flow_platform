...
async function main() {
  ...
  // 5. Seed Deployment Items, Tickets, and Builds
  // Clear old items to avoid duplicates on re-seed
  await prisma.deploymentItem.deleteMany({});

  // Item 1: John merged MAG-20479 on Core for som/1.12.x
  ...
  // Item 2: Alice merged MAG-20550 on E-com for som/1.12.x
  ...
  // Item 3: John merged MAG-20600 on Core for som/1.13.0
