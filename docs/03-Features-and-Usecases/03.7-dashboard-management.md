...
### 2.4 Rich Text & Screenshot Editor (Quill.js)
- **WYSIWYG Sidebar Editing:** Both **Ticket Summary** and **Pending Issues / Remarks** in the create/edit sidebar utilize an integrated `ngx-quill` editor.
- **Rich Formatting:** Supports headings, bold, italic, text & background colors, bullet/number lists, and links.
- **Image Upload & Paste:** Allows direct pasting of screenshots (`Ctrl+V` / `Cmd+V`) and image file uploads.
- **Safe InnerHTML Rendering:** The main dashboard table renders formatted HTML and embedded images cleanly using Angular `[innerHTML]`.
